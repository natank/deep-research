...
A Deep Research demo app: enter a research topic, get a synthesized report (summary, sources, and a data visualization), generated by an LLM-driven pipeline (planner → searcher → writer → emailer).
...
See [`docs/pi-kickoff.md`](docs/pi-kickoff.md) for the next product increment focused on clarification and agentic orchestration.
